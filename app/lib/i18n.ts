...
const VI: Dict = {
  ...
  gallery: { label: '♡ Portfolio', title: 'Tác phẩm', title_accent: 'gần đây', description: 'Lọc theo dịch vụ để xem trước/sau từng loại — tất cả ảnh đều của khách thật tại tiệm.', filter_all: 'Tất cả', filter_brow: 'Chân mày', filter_lip: 'Môi', filter_eye: 'Eyeliner', filter_lash: 'Nối mi' },
...
const EN: Dict = {
  ...
  gallery: { label: '♡ Portfolio', title: 'Recent', title_accent: 'work', description: 'Filter by service to see before/after for each type — all photos from real clients.', filter_all: 'All', filter_brow: 'Brows', filter_lip: 'Lips', filter_eye: 'Eyeliner', filter_lash: 'Lashes' },
...
const RU: Dict = {
  ...
  brands: { microblading: 'Микроблейдинг', lip: 'Татуаж губ', eyeliner: 'Татуаж стрелок', lash: 'Наращивание ресниц', skin: 'Уход за кожей' },
  services_section: { label: '✿ Услуги', title: 'Воспеть красоту', title_accent: 'самым нежным способом', description: '5 фирменных услуг — каждая создана, чтобы подчеркнуть ваши уникальные черты.' },
  services: {
  ...
  gallery: { label: '♡ Портфолио', title: 'Недавние', title_accent: 'работы', description: 'Фильтруйте по услуге, чтобы увидеть результаты «до/после» — все фото от реальных клиентов.', filter_all: 'Все', filter_brow: 'Брови', filter_lip: 'Губы', filter_eye: 'Стрелки', filter_lash: 'Ресницы' },
...
const ZH: Dict = {
  ...
  brands: { microblading: '雾眉', lip: '唇釉', eyeliner: '美瞳线', lash: '种睫毛', skin: '皮肤护理' },
  services_section: { label: '✿ 服务', title: '以最温柔的方式', title_accent: '赞美美丽', description: '5项标志性服务 — 每项都旨在突出您的独特之美。' },
  services: {
  ...
  gallery: { label: '♡ 作品集', title: '近期', title_accent: '作品', description: '按服务筛选查看每种类型的对比图 — 所有照片均来自真实客户。', filter_all: '全部', filter_brow: '眉毛', filter_lip: '唇部', filter_eye: '眼线', filter_lash: '睫毛' },
...
const JA: Dict = {
  ...
  brands: { microblading: 'マイクロブレーディング', lip: 'リップブラッシュ', eyeliner: 'PMUアイライン', lash: 'まつげエクステ', skin: 'スキンケア' },
  services_section: { label: '✿ サービス', title: '最も優しい方法で', title_accent: '美を讃える', description: '5つのシグネチャーサービス — それぞれがあなたのユニークな特徴を引き立てます。' },
  services: {
  ...
  gallery: { label: '♡ ポートフォリオ', title: '最近の', title_accent: '作品', description: 'サービスでフィルターしてビフォー/アフターを表示 — すべて実際のお客様の写真です。', filter_all: 'すべて', filter_brow: '眉', filter_lip: '唇', filter_eye: 'アイライン', filter_lash: 'まつげ' },
...
const KO: Dict = {
  ...
  brands: { microblading: '마이크로블레이딩', lip: '립 블러쉬', eyeliner: '아이라이너 PMU', lash: '속눈썹 연장', skin: '피부 관리' },
  services_section: { label: '✿ 서비스', title: '가장 부드러운 방식으로', title_accent: '아름다움을 기리다', description: '5가지 시그니처 서비스 — 각각 당신만의 특징을 돋보이게 합니다.' },
  services: {
  ...
  gallery: { label: '♡ 포트폴리오', title: '최근', title_accent: '작업', description: '서비스별로 필터링하여 비포/애프터를 확인하세요 — 모든 사진은 실제 고객의 사진입니다.', filter_all: '전체', filter_brow: '눈썹', filter_lip: '입술', filter_eye: '아이라이너', filter_lash: '속눈썹' },
...
const FR: Dict = {
  ...
  brands: { microblading: 'Microblading', lip: 'Lip Blush', eyeliner: 'Eyeliner PMU', lash: 'Extensions de cils', skin: 'Soin de la peau' },
  services_section: { label: '✿ Services', title: 'Célébrer la beauté', title_accent: 'avec douceur', description: '5 services signature — chacun conçu pour mettre en valeur vos traits uniques.' },
  services: {
  ...
  gallery: { label: '♡ Portfolio', title: 'Travaux', title_accent: 'récents', description: 'Filtrez par service pour voir le avant/après — toutes les photos sont de vraies clientes.', filter_all: 'Tout', filter_brow: 'Sourcils', filter_lip: 'Lèvres', filter_eye: 'Eyeliner', filter_lash: 'Cils' },
...
const ES: Dict = {
  ...
  brands: { microblading: 'Microblading', lip: 'Lip Blush', eyeliner: 'Delineador PMU', lash: 'Extensiones de pestañas', skin: 'Cuidado de la piel' },
  services_section: { label: '✿ Servicios', title: 'Celebrar la belleza', title_accent: 'de la manera más suave', description: '5 servicios distintivos — cada uno diseñado para realzar tus rasgos únicos.' },
  services: {
  ...
  gallery: { label: '♡ Portfolio', title: 'Trabajos', title_accent: 'recientes', description: 'Filtra por servicio para ver el antes/después de cada tipo — todas las fotos son de clientas reales.', filter_all: 'Todo', filter_brow: 'Cejas', filter_lip: 'Labios', filter_eye: 'Delineador', filter_lash: 'Pestañas' },
