...
export interface Dict {
  ...
  booking: { label: string; title: string; title_accent: string; description: string; note: string; field_name: string; field_phone: string; field_service: string; field_date: string; field_time: string; field_note: string; field_note_placeholder: string; choose_channel: string; ig_post_link: string; error_name: string; error_phone: string; error_phone_invalid: string; error_date: string };
...
const VI: Dict = {
  ...
  booking: { label: '📅 Đặt lịch 1-click', title: 'Hẹn giờ', title_accent: 'tỏa sáng', description: 'Điền form và chọn kênh — hệ thống sẽ mở WhatsApp / Zalo / Instagram với nội dung đặt lịch soạn sẵn. Phản hồi trong 15 phút.', note: '💡 Lưu ý: Zalo và Instagram chưa hỗ trợ tự điền tin nhắn. Nội dung đặt lịch sẽ được tự động copy vào clipboard — chỉ cần dán vào ô tin nhắn sau khi mở ứng dụng.', field_name: 'Họ tên *', field_phone: 'Số điện thoại *', field_service: 'Dịch vụ', field_date: 'Ngày *', field_time: 'Giờ', field_note: 'Ghi chú (tùy chọn)', field_note_placeholder: 'Em muốn hỏi thêm về...', choose_channel: 'Chọn kênh gửi tin nhắn:', ig_post_link: 'Hoặc xem reel mẫu →', error_name: 'Vui lòng điền họ tên.', error_phone: 'Vui lòng điền số điện thoại.', error_phone_invalid: 'Số điện thoại không hợp lệ. Vui lòng nhập 8-15 chữ số.', error_date: 'Vui lòng chọn ngày.' },
...
const EN: Dict = {
  ...
  booking: { label: '📅 1-click Booking', title: 'Book your', title_accent: 'glow', description: "Fill in the form and pick a channel — you'll be redirected to WhatsApp / Zalo / Instagram with the booking message pre-written. Reply within 15 minutes.", note: "💡 Note: Zalo and Instagram don't support pre-filled messages. The booking text is auto-copied to your clipboard — just paste it into the message box after opening the app.", field_name: 'Full name *', field_phone: 'Phone number *', field_service: 'Service', field_date: 'Date *', field_time: 'Time', field_note: 'Note (optional)', field_note_placeholder: "I'd like to ask about...", choose_channel: 'Choose messaging channel:', ig_post_link: 'Or watch sample reel →', error_name: 'Please enter your name.', error_phone: 'Please enter your phone number.', error_phone_invalid: 'Invalid phone number. Please enter 8-15 digits.', error_date: 'Please select a date.' },
...
const ZH: Dict = {
  ...
  booking: { label: '📅 一键预约', title: '预约您的', title_accent: '光彩', description: '填写表格并选择联系渠道 — 系统将打开 WhatsApp / Zalo / Instagram，预约消息已预先填写。15 分钟内回复。', note: '💡 注意：Zalo 和 Instagram 暂不支持消息预填充。预约内容将自动复制到剪贴板 — 打开应用后粘贴到聊天框即可。', field_name: '全名 *', field_phone: '电话号码 *', field_service: '服务', field_date: '日期 *', field_time: '时间', field_note: '备注（选填）', field_note_placeholder: '我想咨询关于...', choose_channel: '选择联系渠道：', ig_post_link: '或查看示例视频 →', error_name: '请输入您的姓名。', error_phone: '请输入您的电话号码。', error_phone_invalid: '电话号码无效。请输入 8-15 位数字。', error_date: '请选择日期。' },
...
const JA: Dict = {
  ...
  booking: { label: '📅 1クリック予約', title: 'あなたの', title_accent: '輝きを予約', description: 'フォームに記入してチャネルを選択すると、ご予約内容が事前入力された WhatsApp / Zalo / Instagram が開きます。15 分以内に返信いたします。', note: '💡 ご注意：Zalo と Instagram はメッセージの事前入力に対応していません。ご予約内容は自動的にクリップボードにコピーされますので、アプリを開いた後にメッセージ欄に貼り付けてください。', field_name: '氏名 *', field_phone: '電話番号 *', field_service: 'サービス', field_date: '日付 *', field_time: '時間', field_note: 'メモ（任意）', field_note_placeholder: 'お問い合わせ内容...', choose_channel: '連絡チャンネルを選択：', ig_post_link: 'またはサンプル動画を見る →', error_name: '氏名を入力してください。', error_phone: '電話番号を入力してください。', error_phone_invalid: '電話番号が無効です。8〜15桁の数字を入力してください。', error_date: '日付を選択してください。' },
...
const KO: Dict = {
  ...
  booking: { label: '📅 원클릭 예약', title: '당신의', title_accent: '빛남을 예약', description: '양식을 작성하고 채널을 선택하면 예약 메시지가 미리 작성된 WhatsApp / Zalo / Instagram이 열립니다. 15분 이내 답변드립니다.', note: '💡 안내: Zalo와 Instagram은 메시지 자동 채우기를 지원하지 않습니다. 예약 내용이 클립보드에 자동 복사되므로 앱을 연 후 메시지 입력창에 붙여넣어 주세요.', field_name: '성함 *', field_phone: '전화번호 *', field_service: '서비스', field_date: '날짜 *', field_time: '시간', field_note: '메모 (선택)', field_note_placeholder: '문의하고 싶은 내용...', choose_channel: '메시지 채널 선택:', ig_post_link: '또는 샘플 릴 보기 →', error_name: '성함을 입력해주세요.', error_phone: '전화번호를 입력해주세요.', error_phone_invalid: '잘못된 전화번호입니다. 8-15자리 숫자를 입력해주세요.', error_date: '날짜를 선택해주세요.' },
