...
export interface BlogSection {
  ...
  warning?: string;
  tip?: string;
  /** Optional inline image rendered at the end of the section. */
  image?: string;
  /** Alt text / caption for the inline image. */
  imageAlt?: string;
}
...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    sections: {
      VI: [
        { heading: '1. Lip Blush hồng đất — "Vẫn ngon nhất"', subheading: 'Tone hồng pha nâu đất, hợp 90% khách hàng.', paragraphs: ['Lip Blush hồng đất vẫn là vua 2026. Hợp mọi tone da, mọi tuổi, mọi phong cách. Hiệu ứng "vừa cắn quả mọng".'], list: ['Phù hợp: Mọi tone da.', 'Tone phổ biến: #C97C75, #B85F5C.', 'Bền màu: 2-3 năm.', 'Giá CAMI VAN: 4.000.000đ.'], tip: '💡 An toàn nhất nếu lần đầu phun môi.', image: '/portfolio-4.webp', imageAlt: 'Cami Pearl Lips — Lip Blush hồng đất tại CAMI VAN' },
        { heading: '2. Aqua Lip mọng nước — Trend Hàn Quốc', subheading: 'Hiệu ứng môi căng mọng như được dưỡng ẩm liên tục.', paragraphs: ['Mực mỏng + tinh chất dưỡng ẩm sâu, môi luôn "ướt" và mọng. Hợp người môi khô, mỏng, thâm.'], list: ['Phù hợp: Da nhạy cảm, môi khô/mỏng.', 'Tone: Hồng nhạt + ánh bóng.', 'Bền: 2 năm.', 'Giá CAMI VAN: 4.500.000đ.'] },
        { heading: '3. Cherry Lip Hàn Quốc — Đỏ tự nhiên', subheading: 'Đỏ cherry pha hồng, không quá đậm.', paragraphs: ['Trào lưu từ K-Drama. "Vừa cắn cherry" — đỏ tươi nhưng không artificial. Hợp da trắng và mặt nhỏ.'], list: ['Phù hợp: Da trắng, mặt nhỏ, 20-35 tuổi.', 'Tone: #D63A47.', 'Bền: 2.5 năm.', 'Giá CAMI VAN: 4.200.000đ.'], image: '/p4_cherry_lips.webp', imageAlt: 'Cherry Lip — Đỏ tự nhiên tại CAMI VAN' },
        { heading: '4. Berry Lip — Sang chảnh', subheading: 'Đỏ tím nhẹ, sang trọng quyến rũ.', paragraphs: ['Hợp phụ nữ 30+ — chín chắn, thanh lịch. Hiệu ứng việt quất / dâu rừng.'], list: ['Phù hợp: 30+, da trắng/trắng vàng.', 'Tone: #8E3A5C.', 'Bền: 3 năm.', 'Giá CAMI VAN: 4.500.000đ.'], quote: '"Berry Lip là tone yêu thích của khách Nga và 35+." — Cẩm Vân' },
        { heading: '5. Bare Lips / Nude Lip — Tối giản', subheading: 'Gần như không màu — chỉ enhance.', paragraphs: ['Xu hướng mới 2026, dành cho người thích "no makeup makeup". Lớp nude rất nhẹ — giảm thâm, đều màu.', 'Hiệu ứng: "vừa thức dậy mà môi đã đẹp".'], list: ['Phù hợp: Tối giản, công sở.', 'Tone: Nude pink rất nhạt.', 'Bền: 1.5-2 năm.', 'Giá CAMI VAN: 4.000.000đ.'] },
      ...
      EN: [
        { heading: '1. Earth-pink Lip Blush — "Still the best"', subheading: 'Pink-brown shade for 90% of clients.', paragraphs: ['Still king of 2026 trends. Suits every skin tone, age, style. The "just bit a berry" effect.'], list: ['Suitable for: All skin tones.', 'Common shades: #C97C75, #B85F5C.', 'Longevity: 2–3 years.', 'CAMI VAN price: 4,000,000 VND.'], tip: '💡 Safest choice for first-timers.', image: '/portfolio-4.webp', imageAlt: 'Cami Pearl Lips — Earth-pink Lip Blush at CAMI VAN' },
        { heading: '2. Juicy Aqua Lip — From Korea', subheading: 'Lips that look constantly hydrated.', paragraphs: ['Thin pigment + deep hydration serum — permanent "wet" plump look. Great for dry, thin, pigmented lips.'], list: ['Suitable for: Sensitive, dry, thin lips.', 'Shade: Light pink with sheen.', 'Longevity: 2 years.', 'CAMI VAN price: 4,500,000 VND.'] },
        { heading: '3. Korean Cherry Lip — Natural red', subheading: 'Cherry-pink red, not as bold.', paragraphs: ['From K-Drama actresses. "Just bit a cherry" — bright red, never artificial. Best for fair skin and small faces.'], list: ['Suitable for: Fair skin, smaller face, 20–35.', 'Shade: #D63A47.', 'Longevity: 2.5 years.', 'CAMI VAN price: 4,200,000 VND.'], image: '/p4_cherry_lips.webp', imageAlt: 'Cherry Lip — Natural red at CAMI VAN' },
        { heading: '4. Berry Lip — Sophisticated', subheading: 'Subtle red-purple, elegant and alluring.', paragraphs: ['Suits women 30+ — mature, graceful. Like blueberries / wild raspberries.'], list: ['Suitable for: 30+, fair to warm skin.', 'Shade: #8E3A5C.', 'Longevity: 3 years.', 'CAMI VAN price: 4,500,000 VND.'], quote: '"Berry Lip is the favorite among Russian clients and 35+." — Cẩm Vân' },
        { heading: '5. Bare Lips / Nude Lip — Most minimal', subheading: 'Almost no color — just enhances.', paragraphs: ['Newest 2026 trend for "no makeup makeup" style. Very light nude — reduces darkness, evens tone.', 'Effect: "just woke up and lips already beautiful".'], list: ['Suitable for: Minimal style, office.', 'Shade: Very light nude pink.', 'Longevity: 1.5–2 years.', 'CAMI VAN price: 4,000,000 VND.'] },
      ...
      RU: [
        { heading: '1. Earth-pink Lip Blush — "Всё ещё лучший"', subheading: 'Розово-коричневый — для 90% клиентов.', paragraphs: ['Король трендов 2026. Подходит всем тонам кожи, возрастам, стилям. Эффект "только укусили ягоду".'], list: ['Подходит: всем тонам кожи.', 'Оттенки: #C97C75, #B85F5C.', 'Стойкость: 2-3 года.', 'Цена CAMI VAN: 4 000 000 VND.'], tip: '💡 Самый безопасный выбор для новичков.', image: '/portfolio-4.webp', imageAlt: 'Cami Pearl Lips — Lip Blush в CAMI VAN' },
        { heading: '2. Сочный Aqua Lip — Из Кореи', subheading: 'Губы выглядят постоянно увлажнёнными.', paragraphs: ['Тонкий пигмент + сыворотка глубокого увлажнения — постоянный "влажный" вид. Для сухих, тонких, пигментированных губ.'], list: ['Подходит: чувствительные, сухие, тонкие губы.', 'Оттенок: светло-розовый с блеском.', 'Стойкость: 2 года.', 'Цена CAMI VAN: 4 500 000 VND.'] },
        { heading: '3. Корейский Cherry Lip — Натуральный красный', subheading: 'Вишнёво-розовый, не слишком яркий.', paragraphs: ['Из K-Drama. "Только укусили вишню" — яркий, но не искусственный. Лучше для светлой кожи и маленьких лиц.'], list: ['Подходит: светлая кожа, маленькое лицо, 20-35.', 'Оттенок: #D63A47.', 'Стойкость: 2.5 года.', 'Цена CAMI VAN: 4 200 000 VND.'], image: '/p4_cherry_lips.webp', imageAlt: 'Cherry Lip — натуральный красный в CAMI VAN' },
        { heading: '4. Berry Lip — Изысканный', subheading: 'Тонкий красно-фиолетовый, элегантный.', paragraphs: ['Для женщин 30+ — зрелые, грациозные. Как голубика / лесная малина.'], list: ['Подходит: 30+, светлая/тёплая кожа.', 'Оттенок: #8E3A5C.', 'Стойкость: 3 года.', 'Цена CAMI VAN: 4 500 000 VND.'], quote: '"Berry Lip — любимый у русских клиентов и 35+." — Cẩm Vân' },
        { heading: '5. Bare Lips / Nude Lip — Минимализм', subheading: 'Почти без цвета — только усиление.', paragraphs: ['Новейший тренд 2026 для "no makeup makeup". Очень светлый nude — уменьшает темноту, выравнивает тон.', 'Эффект: "только проснулась и губы уже красивые".'], list: ['Подходит: минимализм, офис.', 'Оттенок: очень светлый nude pink.', 'Стойкость: 1.5-2 года.', 'Цена CAMI VAN: 4 000 000 VND.'] },
      ...
      ZH: [
        { heading: '1. 大地玫瑰 Lip Blush — "依然最佳"', subheading: '粉棕色调 — 90% 客户适用。', paragraphs: ['仍是 2026 趋势之王。适合所有肤色、年龄、风格。"刚咬过浆果"效果。'], list: ['适合：所有肤色。', '常见色调：#C97C75、#B85F5C。', '持久：2-3 年。', 'CAMI VAN 价：4,000,000 越南盾。'], tip: '💡 初次纹唇最安全选择。', image: '/portfolio-4.webp', imageAlt: 'Cami Pearl Lips — CAMI VAN 大地玫瑰 Lip Blush' },
        { heading: '2. 水润 Aqua Lip — 韩国趋势', subheading: '双唇看起来持续保湿。', paragraphs: ['薄色乳 + 深层保湿精华 — 持久"湿润"丰满。适合干燥、薄、暗沉双唇。'], list: ['适合：敏感、干燥、薄唇。', '色调：浅粉带光泽。', '持久：2 年。', 'CAMI VAN 价：4,500,000 越南盾。'] },
        { heading: '3. 韩式 Cherry Lip — 自然红', subheading: '樱桃粉红色，不太浓。', paragraphs: ['来自韩剧女演员。"刚咬过樱桃" — 鲜红但不假。适合白皮肤、小脸。'], list: ['适合：白皮肤、小脸、20-35 岁。', '色调：#D63A47。', '持久：2.5 年。', 'CAMI VAN 价：4,200,000 越南盾。'], image: '/p4_cherry_lips.webp', imageAlt: 'Cherry Lip — CAMI VAN 自然红' },
        { heading: '4. Berry Lip — 精致', subheading: '微妙红紫，优雅迷人。', paragraphs: ['适合 30+ 女性 — 成熟优雅。如蓝莓 / 野莓效果。'], list: ['适合：30+，白/暖肤。', '色调：#8E3A5C。', '持久：3 年。', 'CAMI VAN 价：4,500,000 越南盾。'], quote: '"Berry Lip 是俄罗斯客户和 35+ 客户的最爱。" — Cẩm Vân' },
        { heading: '5. Bare Lips / Nude Lip — 极简', subheading: '几乎无色 — 仅增强。', paragraphs: ['2026 最新趋势，适合"无妆妆"风格。极轻 nude — 减暗沉、均色。', '效果："刚醒来唇就美"。'], list: ['适合：极简、办公室。', '色调：极浅 nude pink。', '持久：1.5-2 年。', 'CAMI VAN 价：4,000,000 越南盾。'] },
      ...
      JA: [
        { heading: '1. アースピンク Lip Blush — "やはり最強"', subheading: 'ピンクブラウン — 90% のお客様に。', paragraphs: ['2026 トレンドの王者。あらゆる肌色、年齢、スタイルに合う。"ベリーを噛んだばかり"効果。'], list: ['対象：全ての肌色。', '一般色：#C97C75、#B85F5C。', '持続：2〜3 年。', 'CAMI VAN 価格：4,000,000 ベトナムドン。'], tip: '💡 初心者に最も安全。', image: '/portfolio-4.webp', imageAlt: 'Cami Pearl Lips — CAMI VAN のアースピンク Lip Blush' },
        { heading: '2. ジューシー Aqua Lip — 韓国発', subheading: '常に潤った唇に見える。', paragraphs: ['薄い色素 + 深層保湿セラム — 永続的な"濡れた"ふっくら感。乾燥・薄い・色素沈着唇に最適。'], list: ['対象：敏感、乾燥、薄い唇。', '色調：ライトピンク + 光沢。', '持続：2 年。', 'CAMI VAN 価格：4,500,000 ベトナムドン。'] },
        { heading: '3. 韓国 Cherry Lip — 自然な赤', subheading: 'チェリーピンクレッド、控えめ。', paragraphs: ['K-Drama 女優から。"チェリーを噛んだばかり" — 明るい赤だが人工的でない。色白と小顔向き。'], list: ['対象：色白、小顔、20〜35 歳。', '色調：#D63A47。', '持続：2.5 年。', 'CAMI VAN 価格：4,200,000 ベトナムドン。'], image: '/p4_cherry_lips.webp', imageAlt: 'Cherry Lip — CAMI VAN の自然な赤' },
        { heading: '4. Berry Lip — 洗練', subheading: '微妙な赤紫、エレガントで魅惑的。', paragraphs: ['30+ の女性に — 成熟、優雅。ブルーベリー / 野いちごのよう。'], list: ['対象：30+、色白〜暖色肌。', '色調：#8E3A5C。', '持続：3 年。', 'CAMI VAN 価格：4,500,000 ベトナムドン。'], quote: '"Berry Lip はロシアのお客様と 35+ のお気に入り。" — Cẩm Vân' },
        { heading: '5. Bare Lips / Nude Lip — ミニマル', subheading: 'ほぼ無色 — 強調のみ。', paragraphs: ['2026 最新トレンド、"ノーメイクメイク"向け。極薄ヌード — 暗さ軽減、均一な色。', '効果："起きたばかりなのに唇は美しい"。'], list: ['対象：ミニマル、オフィス。', '色調：極薄ヌードピンク。', '持続：1.5〜2 年。', 'CAMI VAN 価格：4,000,000 ベトナムドン。'] },
      ...
      KO: [
        { heading: '1. 어스 핑크 Lip Blush — "여전히 최고"', subheading: '핑크-브라운 톤 — 90% 고객에게 적합.', paragraphs: ['여전히 2026 트렌드의 왕. 모든 피부톤, 연령, 스타일에 적합. "베리를 막 베어 문" 효과.'], list: ['적합: 모든 피부톤.', '일반 톤: #C97C75, #B85F5C.', '지속: 2-3년.', 'CAMI VAN 가격: 4,000,000 동.'], tip: '💡 첫 시술자에게 가장 안전.', image: '/portfolio-4.webp', imageAlt: 'Cami Pearl Lips — CAMI VAN의 어스 핑크 Lip Blush' },
        { heading: '2. 촉촉한 Aqua Lip — 한국 트렌드', subheading: '입술이 지속적으로 보습된 듯.', paragraphs: ['얇은 색소 + 깊은 보습 세럼 — 영구적인 "촉촉한" 도톰함. 건조하고 얇고 어두운 입술에 좋음.'], list: ['적합: 민감, 건조, 얇은 입술.', '톤: 라이트 핑크 + 광택.', '지속: 2년.', 'CAMI VAN 가격: 4,500,000 동.'] },
        { heading: '3. 한국 Cherry Lip — 자연스러운 빨강', subheading: '체리 핑크 레드, 너무 진하지 않음.', paragraphs: ['K-드라마 여배우들로부터. "체리를 막 베어 문" — 밝은 빨강이지만 인위적이지 않음. 흰 피부와 작은 얼굴에 최적.'], list: ['적합: 흰 피부, 작은 얼굴, 20-35세.', '톤: #D63A47.', '지속: 2.5년.', 'CAMI VAN 가격: 4,200,000 동.'], image: '/p4_cherry_lips.webp', imageAlt: 'Cherry Lip — CAMI VAN의 자연스러운 빨강' },
        { heading: '4. Berry Lip — 세련', subheading: '미묘한 레드-퍼플, 우아하고 매혹적.', paragraphs: ['30대 이상 여성에게 — 성숙, 우아. 블루베리 / 산딸기 같은 효과.'], list: ['적합: 30+, 흰/따뜻한 피부.', '톤: #8E3A5C.', '지속: 3년.', 'CAMI VAN 가격: 4,500,000 동.'], quote: '"Berry Lip은 러시아 고객과 35+의 즐겨찾기." — Cẩm Vân' },
        { heading: '5. Bare Lips / Nude Lip — 가장 미니멀', subheading: '거의 무색 — 강조만.', paragraphs: ['"노메이크업 메이크업" 스타일을 위한 2026 최신 트렌드. 매우 가벼운 누드 — 어두움 감소, 톤 균일.', '효과: "일어나자마자 입술이 이미 아름다움".'], list: ['적합: 미니멀, 사무실.', '톤: 매우 가벼운 누드 핑크.', '지속: 1.5-2년.', 'CAMI VAN 가격: 4,000,000 동.'] },
      ...
      FR: [
        { heading: '1. Lip Blush rose terre — "Toujours le meilleur"', subheading: 'Rose-brun — pour 90% des clientes.', paragraphs: ["Toujours roi des tendances 2026. Convient à tous les tons, âges, styles. Effet \"juste mordu une baie\"."], list: ['Convient : Tous tons de peau.', 'Tons courants : #C97C75, #B85F5C.', 'Tenue : 2-3 ans.', 'Prix CAMI VAN : 4 000 000 VND.'], tip: '💡 Le plus sûr pour les débutantes.', image: '/portfolio-4.webp', imageAlt: 'Cami Pearl Lips — Lip Blush rose terre chez CAMI VAN' },
        { heading: '2. Aqua Lip juteux — Tendance Corée', subheading: 'Lèvres semblent constamment hydratées.', paragraphs: ['Pigment fin + sérum hydratant — effet "humide" pulpeux permanent. Idéal pour lèvres sèches, fines, pigmentées.'], list: ['Convient : Sensibles, sèches, fines.', 'Ton : Rose clair brillant.', 'Tenue : 2 ans.', 'Prix CAMI VAN : 4 500 000 VND.'] },
        { heading: '3. Cherry Lip coréen — Rouge naturel', subheading: 'Rouge cerise-rose, jamais trop marqué.', paragraphs: ["Des actrices K-Drama. \"Juste mordu une cerise\" — rouge vif jamais artificiel. Idéal teint clair et petit visage."], list: ['Convient : Teint clair, petit visage, 20-35 ans.', 'Ton : #D63A47.', 'Tenue : 2,5 ans.', 'Prix CAMI VAN : 4 200 000 VND.'], image: '/p4_cherry_lips.webp', imageAlt: 'Cherry Lip — Rouge naturel chez CAMI VAN' },
        { heading: '4. Berry Lip — Raffiné', subheading: 'Rouge-violet subtil, élégant.', paragraphs: ['Pour femmes 30+ — mature, gracieux. Comme myrtilles / framboises sauvages.'], list: ['Convient : 30+, peau claire/chaude.', 'Ton : #8E3A5C.', 'Tenue : 3 ans.', 'Prix CAMI VAN : 4 500 000 VND.'], quote: '"Berry Lip est le favori de mes clientes russes et 35+." — Cẩm Vân' },
        { heading: '5. Bare Lips / Nude Lip — Le plus minimaliste', subheading: "Quasi sans couleur — juste rehaussé.", paragraphs: ['Tendance 2026 pour "no makeup makeup". Nude très léger — réduit obscurcissement, uniformise.', "Effet : \"juste réveillée et lèvres déjà belles\"."], list: ['Convient : Style minimal, bureau.', 'Ton : Nude pink très clair.', 'Tenue : 1,5-2 ans.', 'Prix CAMI VAN : 4 000 000 VND.'] },
      ...
      ES: [
        { heading: '1. Lip Blush rosa tierra — "Aún el mejor"', subheading: 'Rosa-marrón — para 90% de clientas.', paragraphs: ['Sigue siendo el rey de tendencias 2026. Apto para todos los tonos, edades, estilos. Efecto "recién mordí una baya".'], list: ['Apto: Todos los tonos.', 'Tonos comunes: #C97C75, #B85F5C.', 'Duración: 2-3 años.', 'Precio CAMI VAN: 4.000.000 VND.'], tip: '💡 Lo más seguro para principiantes.', image: '/portfolio-4.webp', imageAlt: 'Cami Pearl Lips — Lip Blush rosa tierra en CAMI VAN' },
        { heading: '2. Aqua Lip jugoso — Tendencia coreana', subheading: 'Labios parecen siempre hidratados.', paragraphs: ['Pigmento fino + sérum hidratante — efecto "húmedo" voluminoso permanente. Ideal para labios secos, finos, pigmentados.'], list: ['Apto: Sensibles, secos, finos.', 'Tono: Rosa claro con brillo.', 'Duración: 2 años.', 'Precio CAMI VAN: 4.500.000 VND.'] },
        { heading: '3. Cherry Lip coreano — Rojo natural', subheading: 'Cereza-rosa rojo, nunca demasiado.', paragraphs: ['De actrices K-Drama. "Recién mordí una cereza" — rojo vivo nunca artificial. Ideal piel clara y rostro pequeño.'], list: ['Apto: Piel clara, rostro pequeño, 20-35 años.', 'Tono: #D63A47.', 'Duración: 2,5 años.', 'Precio CAMI VAN: 4.200.000 VND.'], image: '/p4_cherry_lips.webp', imageAlt: 'Cherry Lip — Rojo natural en CAMI VAN' },
        { heading: '4. Berry Lip — Sofisticado', subheading: 'Rojo-violeta sutil, elegante.', paragraphs: ['Para mujeres 30+ — maduro, grácil. Como arándanos / frambuesas silvestres.'], list: ['Apto: 30+, piel clara/cálida.', 'Tono: #8E3A5C.', 'Duración: 3 años.', 'Precio CAMI VAN: 4.500.000 VND.'], quote: '"Berry Lip es el favorito de mis clientas rusas y 35+." — Cẩm Vân' },
        { heading: '5. Bare Lips / Nude Lip — Lo más minimal', subheading: 'Casi sin color — solo realza.', paragraphs: ['Tendencia 2026 para "no makeup makeup". Nude muy ligero — reduce oscurecimiento, uniforma.', 'Efecto: "recién despertada y labios ya hermosos".'], list: ['Apto: Estilo minimal, oficina.', 'Tono: Nude pink muy claro.', 'Duración: 1,5-2 años.', 'Precio CAMI VAN: 4.000.000 VND.'] },
