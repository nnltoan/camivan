...
const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    source: 'google',
    date: { VI: 'Một năm trước', EN: 'A year ago', RU: 'Год назад', ZH: '一年前', JA: '1 年前', KO: '1년 전', FR: 'Il y a un an', ES: 'Hace un año' },
    service: { VI: 'Gội đầu & massage', EN: 'Hair & massage', RU: 'Уход и массаж', ZH: '洗头 & 按摩', JA: 'シャンプー & マッサージ', KO: '두피 & 마사지', FR: 'Coiffure & massage', ES: 'Lavado y masaje' },
    text: {
      VI: 'Chỗ này gội đầu, massage cổ vai gáy cực sướng, giá lại hợp lý. Nói chung rất hài lòng với tay nghề của nhân viên.',
      EN: 'The hair wash and neck-shoulder massage here are absolutely heavenly, and the price is reasonable. Overall, very happy with the staff\'s skills.',
      RU: 'Мойка головы и массаж шеи и плеч здесь невероятно расслабляющие, и цена адекватная. В целом очень довольна мастерами.',
      ZH: '这家的洗头、肩颈按摩超级享受，价格也合理。总之对员工的手艺很满意。',
      JA: 'シャンプーと首肩マッサージが最高に気持ち良く、価格もお手頃。総じてスタッフの技術にとても満足しています。',
      KO: '여기 두피 케어와 목·어깨 마사지가 정말 끝내줘요. 가격도 합리적이에요. 직원 실력에 전반적으로 만족합니다.',
      FR: "Le lavage de cheveux et le massage cou-épaules sont divins, et les prix raisonnables. Globalement, très satisfaite du savoir-faire de l'équipe.",
      ES: 'El lavado de pelo y el masaje cuello-hombros son una delicia, y los precios razonables. En general, muy contenta con la calidad del equipo.',
    },
  },
  {
    name: 'Leslie Crowder',
